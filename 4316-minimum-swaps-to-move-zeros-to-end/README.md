<h2><a href="https://leetcode.com/problems/minimum-swaps-to-move-zeros-to-end">Minimum Swaps to Move Zeros to End</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>You are given an integer array <code>nums</code>.</p>
