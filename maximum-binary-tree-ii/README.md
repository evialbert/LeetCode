<h2>998. Maximum Binary Tree II</h2><h3>Medium</h3><hr><div><p>A <strong>maximum tree</strong> is a tree where every node has a value greater than any other value in its subtree.</p>
