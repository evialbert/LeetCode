<h2>1111. Maximum Nesting Depth of Two Valid Parentheses Strings</h2><h3>Medium</h3><hr><div><p>A string is a <em>valid parentheses string</em>&nbsp;(denoted VPS) if and only if it consists of <code>"("</code> and <code>")"</code> characters only, and:</p>
