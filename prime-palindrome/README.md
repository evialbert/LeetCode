<h2>866. Prime Palindrome</h2><h3>Medium</h3><hr><div><p>Find the smallest prime palindrome greater than or equal to <code>n</code>.</p>
...
<pre><strong>Input: </strong>n = <span id="example-input-1-1">6</span>
...
<pre><strong>Input: </strong>n = <span id="example-input-2-1">8</span>
...
<pre><strong>Input: </strong>n = <span id="example-input-3-1">13</span>
