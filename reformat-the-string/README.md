<h2>1417. Reformat The String</h2><h3>Easy</h3><hr><div><p>Given alphanumeric string <code>s</code>. (<strong>Alphanumeric string</strong> is a string consisting of lowercase English letters and digits).</p>
