<h2><a href="https://leetcode.com/problems/maximum-height-of-a-triangle/">3200. Maximum Height of a Triangle</a></h2><h3>Easy</h3><hr><div><p>You are given two integers <code>red</code> and <code>blue</code> representing the count of red and blue colored balls. You have to arrange these balls to form a triangle such that the 1<sup>st</sup> row will have 1 ball, the 2<sup>nd</sup> row will have 2 balls, the 3<sup>rd</sup> row will have 3 balls, and so on.</p>
