<h2>1157. Online Majority Element In Subarray</h2><h3>Hard</h3><hr><div><p>Design a data structure that efficiently finds the <strong>majority element</strong> of a given subarray.</p>
