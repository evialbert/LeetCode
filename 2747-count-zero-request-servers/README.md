<h2><a href="https://leetcode.com/problems/count-zero-request-servers/">2747. Count Zero Request Servers</a></h2><h3>Medium</h3><hr><div><p>You are given an integer <code>n</code> denoting the total number of servers and a <strong>2D</strong> <strong>0-indexed </strong>integer array <code>logs</code>, where <code>logs[i] = [server_id, time]</code> denotes that the server with id <code>server_id</code> received a request at time <code>time</code>.</p>
