<h2>1028. Recover a Tree From Preorder Traversal</h2><h3>Hard</h3><hr><div><p>We run a&nbsp;preorder&nbsp;depth-first search (DFS) on the <code>root</code> of a binary tree.</p>
