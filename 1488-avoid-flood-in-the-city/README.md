<h2><a href="https://leetcode.com/problems/avoid-flood-in-the-city/">1488. Avoid Flood in The City</a></h2><h3>Medium</h3><hr><div><p>Your country has an infinite number of lakes. Initially, all the lakes are empty, but when it rains over the <code>nth</code> lake, the <code>nth</code> lake becomes full of water. If it rains over a lake which is <strong>full of water</strong>, there will be a <strong>flood</strong>. Your goal is to avoid the flood in any lake.</p>
