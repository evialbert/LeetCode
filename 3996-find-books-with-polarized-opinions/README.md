<h2><a href="https://leetcode.com/problems/find-books-with-polarized-opinions">Find Books with Polarized Opinions</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>Table: <code>books</code></p>
