<h2>675. Cut Off Trees for Golf Event</h2><h3>Hard</h3><hr><div><p>You are asked to cut off all the trees in a forest for a golf event. The forest is represented as an <code>m x n</code> matrix. In this matrix:</p>
