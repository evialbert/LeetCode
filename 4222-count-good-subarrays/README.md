<h2><a href="https://leetcode.com/problems/count-good-subarrays">Count Good Subarrays</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an integer array <code>nums</code>.</p>
