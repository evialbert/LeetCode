<h2>915. Partition Array into Disjoint Intervals</h2><h3>Medium</h3><hr><div><p>Given an integer array <code>nums</code>, partition it into two (contiguous) subarrays <code>left</code> and <code>right</code> so that:</p>
