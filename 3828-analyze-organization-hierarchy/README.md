<h2><a href="https://leetcode.com/problems/analyze-organization-hierarchy">Analyze Organization Hierarchy</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>Table: <code>Employees</code></p>
