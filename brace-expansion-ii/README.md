<h2>1096. Brace Expansion II</h2><h3>Hard</h3><hr><div><p>Under the grammar given below, strings can represent a set of lowercase words. Let's use <code>R(expr)</code> to denote the set of words the expression represents.</p>
