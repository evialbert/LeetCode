<h2>1292. Maximum Side Length of a Square with Sum Less than or Equal to Threshold</h2><h3>Medium</h3><hr><div><p>Given a <code>m x n</code>&nbsp;matrix <code>mat</code> and an integer <code>threshold</code>. Return the maximum side-length of a square with a sum less than or equal to <code>threshold</code> or return <strong>0</strong> if there is no such square.</p>
