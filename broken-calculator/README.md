<h2>991. Broken Calculator</h2><h3>Medium</h3><hr><div><p>There is a broken calculator that has the integer <code>startValue</code> on its display initially. In on operation you can:</p>
