<h2><a href="https://leetcode.com/problems/minimum-sensors-to-cover-grid">Minimum Sensors to Cover Grid</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given <code>n &times; m</code> grid and an integer <code>k</code>.</p>
