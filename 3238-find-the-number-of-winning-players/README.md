<h2><a href="https://leetcode.com/problems/find-the-number-of-winning-players/">3238. Find the Number of Winning Players</a></h2><h3>Easy</h3><hr><div><p>You are given an integer <code>n</code> representing the number of players in a game and a 2D array <code>pick</code> where <code>pick[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> represents that the player <code>x<sub>i</sub></code> picked a ball of color <code>y<sub>i</sub></code>.</p>
