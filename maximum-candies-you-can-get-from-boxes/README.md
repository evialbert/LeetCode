<h2>1298. Maximum Candies You Can Get from Boxes</h2><h3>Hard</h3><hr><div><p>Given <code>n</code> boxes, each box is given in the format <code>[status, candies, keys, containedBoxes]</code> where:</p>
