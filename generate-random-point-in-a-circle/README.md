<h2>478. Generate Random Point in a Circle</h2><h3>Medium</h3><hr><div><p>Given the radius and the position of the center of a circle, implement the function <code>randPoint</code> which generates a uniform random point inside the circle.</p>
