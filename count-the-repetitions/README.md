<h2>466. Count The Repetitions</h2><h3>Hard</h3><hr><div><p>Define <code>S = [s,n]</code> as the string S which consists of n connected strings s. For example, <code>["abc", 3]</code> ="abcabcabc". </p>
