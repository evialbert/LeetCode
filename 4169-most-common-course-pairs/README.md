<h2><a href="https://leetcode.com/problems/most-common-course-pairs">Most Common Course Pairs</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>Table: <code>course_completions</code></p>
