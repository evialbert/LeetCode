<h2>922. Sort Array By Parity II</h2><h3>Easy</h3><hr><div><p>Given an array <code>A</code>&nbsp;of non-negative integers, half of the integers in A are odd, and half of the integers are even.</p>
