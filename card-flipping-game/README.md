<h2>822. Card Flipping Game</h2><h3>Medium</h3><hr><div><p>On a table are <code>N</code> cards, with a positive integer printed on the front and back of each card (possibly different).</p>
