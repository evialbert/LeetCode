<h2>982. Triples with Bitwise AND Equal To Zero</h2><h3>Hard</h3><hr><div><p>Given an integer array nums, return <em>the number of <strong>AND triples</strong></em>.</p>
