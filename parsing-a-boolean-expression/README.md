<h2>1106. Parsing A Boolean Expression</h2><h3>Hard</h3><hr><div><p>Return the result of evaluating a given boolean <code>expression</code>, represented as a string.</p>
