<h2>1116. Print Zero Even Odd</h2><h3>Medium</h3><hr><div><p>You have a function <code>printNumber</code> that can be called with an integer parameter and prints it to the console.</p>
