<h2>1017. Convert to Base -2</h2><h3>Medium</h3><hr><div><p>Given an integer <code>n</code>, return <em>a binary string representing its representation in base</em> <code>-2</code>.</p>
