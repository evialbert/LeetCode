<h2>731. My Calendar II</h2><h3>Medium</h3><hr><div><p>Implement a <code>MyCalendarTwo</code> class to store your events. A new event can be added if adding the event will not cause a <b>triple</b> booking.</p>
