<h2>825. Friends Of Appropriate Ages</h2><h3>Medium</h3><hr><div><p>Some people will make friend requests. The&nbsp;list of their ages is given and&nbsp;<code>ages[i]</code>&nbsp;is the age of the&nbsp;ith person.&nbsp;</p>
