<h2>1253. Reconstruct a 2-Row Binary Matrix</h2><h3>Medium</h3><hr><div><p>Given the following details of a matrix with <code>n</code> columns and <code>2</code> rows :</p>
