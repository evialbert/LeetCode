<h2>1240. Tiling a Rectangle with the Fewest Squares</h2><h3>Hard</h3><hr><div><p>Given a rectangle of size <code>n</code> x <code>m</code>, return <em>the minimum number of integer-sided squares that tile the rectangle</em>.</p>
