<h2>591. Tag Validator</h2><h3>Hard</h3><hr><div><p>Given a string representing a code snippet, implement a tag validator to parse the code and return whether it is valid.</p>
